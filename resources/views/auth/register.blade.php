    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card loginBox">
                <div class="card-header text-center"><h2 class="text-danger">{{ __('Register') }}</h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="feature_image_path" type="file" class="form-control @error('email') is-invalid @enderror" name="feature_image_path" required>
